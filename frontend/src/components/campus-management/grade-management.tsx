...
const GRADE_SUGGESTIONS = ['Nursery', 'KG-I', 'KG-II', 'Grade 1', 'Grade 2', 'Grade 3', 'Grade 4', 'Grade 5', 'Grade 6', 'Grade 7', 'Grade 8', 'Grade 9', 'Grade 10', 'Matric'];
...
export default function GradeManagement({ campusId }: GradeManagementProps) {
  ...
  const [suggestions, setSuggestions] = useState<string[]>(['Nursery', 'KG-I', 'KG-II', 'Grade 1', 'Grade 2', 'Grade 3', 'Grade 4', 'Grade 5', 'Grade 6', 'Grade 7', 'Grade 8', 'Grade 9', 'Grade 10', 'Matric'])
