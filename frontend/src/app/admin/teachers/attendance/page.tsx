...
function TeacherAttendanceContent() {
  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto mt-8 p-4 sm:p-6 space-y-6 sm:space-y-8 animate-in fade-in duration-500">
        {/* Header Skeleton */}
    ...
    <div className="max-w-7xl mx-auto mt-4 sm:mt-6 lg:mt-8 p-2 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
      ...
      {!selectedHoliday && (
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
          <Card className="bg-green-50/50 border-green-200 border text-green-700 shadow-sm hover:shadow-md transition-all duration-200">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium opacity-90">Present</p>
                  <p className="text-lg sm:text-xl lg:text-2xl font-bold">{presentCount}</p>
                </div>
                <CheckCircle className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-green-500/80" />
              </div>
            </CardContent>
          </Card>

          <Card className="bg-red-50/50 border-red-200 border text-red-700 shadow-sm hover:shadow-md transition-all duration-200">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium opacity-90">Absent</p>
                  <p className="text-lg sm:text-xl lg:text-2xl font-bold">{absentCount}</p>
                </div>
                <XCircle className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-red-500/80" />
              </div>
            </CardContent>
          </Card>

          <Card className="bg-blue-50/50 border-blue-200 border text-blue-700 shadow-sm hover:shadow-md transition-all duration-200">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium opacity-90">Leave</p>
                  <p className="text-lg sm:text-xl lg:text-2xl font-bold">{leaveCount}</p>
                </div>
                <Calendar className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-blue-500/80" />
              </div>
            </CardContent>
          </Card>

          <Card className="bg-slate-50/50 border-slate-200 border text-slate-700 shadow-sm hover:shadow-md transition-all duration-200">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs sm:text-sm font-medium opacity-90">{attendancePercentage}%</p>
                </div>
                <Users className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-slate-500/80" />
              </div>
            </CardContent>
          </Card>
        </div>
