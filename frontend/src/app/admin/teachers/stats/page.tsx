...
import { getCurrentUserProfile, getClassroomStudents, getTeacherTodayAttendance, getTeacherWeeklyAttendance, getTeacherMonthlyTrend, getAttendanceHistory, getClassTimetable, getShiftTimings } from "@/lib/api"
import { getCurrentUserRole, usePermissions } from "@/lib/permissions"
import { AccessDenied } from "@/components/AccessDenied"
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, PieChart, Pie, Cell, LineChart, Line, Area, AreaChart } from "recharts"
import { Skeleton } from "@/components/ui/skeleton"
import { BarChart2, UserCheck, Users as UsersIcon, Award, CalendarCheck, BookOpen, UserPlus, FileText, PieChart as PieChartIcon, TrendingUp as TrendingUpIcon, Activity, Clock, Star, History as HistoryIcon, Calendar, Plus } from "lucide-react"
...
export default function TeacherClassDashboard() {
  const { canViewTeacherDashboard } = usePermissions();
      ...
      try {
        ...
        if (role === 'teacher') {
          ...
          const [classroomData, todayAttendance, weeklyAttendance, monthlyTrend, last30DaysHistory, classTimetable, shiftSlots] = await Promise.all([
            ...
            getShiftTimings(teacherProfile?.campus?.id || 1, classroomToUse.shift || 'morning')
          ])
