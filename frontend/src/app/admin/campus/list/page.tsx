                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {c.city && (
                              <div className="text-xs text-slate-500 mt-1">
                                {c.city.split(' ').map((w: string) => w.charAt(0).toUpperCase() + w.slice(1).toLowerCase()).join(' ')}
                                {c.district
                                  ? `, ${c.district.split(' ').map((w: string) => w.charAt(0).toUpperCase() + w.slice(1).toLowerCase()).join(' ')}`
                                  : ''
                                }
                              </div>
                            )}
