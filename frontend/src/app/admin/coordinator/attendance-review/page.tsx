...
export default function AttendanceReviewPage() {
  ...
  useEffect(() => {
    document.title = "Attendance Review - Coordinator | Newton AMS";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {classroomAttendanceSummary
              ...
              .map((summary) => {
                ...
                const canApprove = !summary.is_holiday && (hasCounts || ALLOWED_APPROVE_STATUSES.includes(String(st))) && canApproveAttendance;
                ...
                return (
                  <div
                    ...
                    className={`bg-gray-50 rounded-lg p-6 border-2 transition ease-in-out duration-150 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#6096ba] ${isSelected ? 'border-green-500 bg-green-50 shadow-md' : 'border-gray-200 hover:shadow-md'
                      }`}
                  >
