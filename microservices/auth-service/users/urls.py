...
urlpatterns = [
    ...
    # Internal service-to-service endpoints (protected by INTERNAL_SERVICE_SECRET)
    path('internal/create-user/', internal_create_user, name='internal_create_user'),
    path('internal/sync-org/', internal_sync_org, name='internal_sync_org'),
