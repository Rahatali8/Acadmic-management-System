...
SECRET_KEY = os.getenv("SECRET_KEY", "timetable-service-secret")
...
ROOT_URLCONF = "timetable_service.urls"
WSGI_APPLICATION = "timetable_service.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("DB_PASSWORD", "timetable_pass"),
        "HOST": os.getenv("DB_HOST", "postgres-timetable"),
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.getenv("REDIS_URL", "redis://redis:6379/9"),
